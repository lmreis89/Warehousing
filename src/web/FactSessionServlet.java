...
public class FactSessionServlet extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		String factID = (String) request.getParameter("factID");
		String display = request.getParameter("display");
		proc.setFactOccur(op.equals("after")? 1 : 0);
		proc.setFactID(factID);
